  ...
  loadWhiteboard: function (whiteboardContainer, newSettings) {
    ...
    _this.mouseup = function (e) {
      ...
      if (_this.tool === "mouse") {
        ...
        _this.drawImgToCanvas(url, _this.thickness * 12, _this.thickness * 12, topLeftX, topLeftY);
        _this.sendFunction({
          t: _this.tool,
          d: [topLeftX, topLeftY],
          c: _this.drawcolor,
    ...
    _this.textContainer.on("click", function (e) {
      ...
      _this.addTextBox(_this.drawcolor, fontsize, currentPos.x, currentPos.y, txId, true, true);
    });
  },
  /**
